...
namespace cmdmessenger
{
    ...
    public:
         ...
         * @brief Constructor
         *
         * @param field_separator The character used to seperate fields in a single command
         * @param command_separator The character used to seperate commands
         * @param escape_character The character used to escape the seperators
         */
         ...
         *
         * @param device The device to send the comand to
         ...
         *
         * @param acknowledgement The string returned by the device after sending a command
         * @param command The command metadat for the command sent
         *
         ...
         * @exception IncorrectCommandSeparator Thrown if the acknowledgement does not end with the correct command separator
        ...
        {
            // First part should be the acknowledgement id
    ...
    private:
         ...
         *
         *  @exception Uncovertible Argument
         */
        template<typename T>
    ...
    /**
     * @typedef ArduinoCmdMessenger CmdMessenger with all the types that arduino uses
     */
