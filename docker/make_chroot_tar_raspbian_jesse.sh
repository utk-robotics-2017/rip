...
# Original: https://github.com/sdhibit/docker-rpi-raspbian/blob/master/mkimage-raspbian.sh
# Changes: Robobenklein

set -e

dir="raspbian"
rootfsDir="raspbian"
tarFile="raspbian.$(date --rfc-3339=date).$(hostname).tar.xz"
