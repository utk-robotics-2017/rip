...
namespace rip
{
    namespace appendages
    {
        ...
        protected:
             ...
             * @see {@link Command}
             */
            std::shared_ptr<cmdmessenger::Command> createCommand(const std::string& command_key, const std::map<std::string, int>& command_map, const std::string& parameter_string);
