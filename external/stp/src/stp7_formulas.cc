...
namespace stp
{
     ...
     * set to zero.
     */
    void Stp7Formulas::solveProfile(double t[8],
    ...
    bool Stp7Formulas::areValidTimeIntervalls(double t[8])
    {
     ...
     */
    void Stp7Formulas::calcCoeffs(double coeffs[7],
                                  string type, bool bCruise, bool bDoubleDec, bool bDecAcc, bool bMoveForward,
                                  double x0, double xTarget, double v0, double vmax,
     ...
     */
    void Stp7Formulas::calcTimeIntervalls(double t[8],
                                          string type, bool bCruise, bool bDoubleDec, bool bDecAcc, bool bMoveForward,
    ...
    void Stp7Formulas::calcCoeffsProfileTT(double coeffs[7], double x0, double xTarget,
    ...
    void Stp7Formulas::calcTimeIntervallsProfileTT(double t[8], double root,
            double x0, double xTarget, double v0, double vmax,
    ...
    void Stp7Formulas::calcCoeffsProfileWW(double coeffs[7], double x0, double xTarget,
                                           double v0, double vmax, double a0, double amax, double jmax, double da, double dc)
    {
        double amax2 = amax * amax;
    ...
    void Stp7Formulas::calcTimeIntervallsProfileWW(double t[8], double root,
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc)
    {
        double a2 = a0 * a0;
    ...
    void Stp7Formulas::calcCoeffsProfileWT(double coeffs[7], double x0, double xTarget,
                                           double v0, double vmax, double a0, double amax, double jmax, double da, double dc)
    {
        double a2 = a0 * a0;
        double amax2 = amax * amax;
    ...
    void Stp7Formulas::calcTimeIntervallsProfileWT(double t[8], double root,
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc)
    {
        double a2 = a0 * a0;
    ...
    void Stp7Formulas::calcCoeffsProfileTW(double coeffs[7], double x0, double xTarget,
                                           double v0, double vmax, double a0, double amax, double jmax, double da, double dc)
    {
        double a2 = a0 * a0;
        double amax2 = amax * amax;
    ...
    void Stp7Formulas::calcTimeIntervallsProfileTW(double t[8], double root,
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc)
    {
        double a2 = a0 * a0;
     ...
     */
    void Stp7Formulas::calcCoeffsDoubleDecProfile_T(double coeffs[7], double x0, double xTarget,
    ...
    void Stp7Formulas::calcTimeIntervallsDoubleDecProfile_T(double t[8], double root,
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc)
    {
        t[3] = root / dc / jmax;
     ...
     * t[1] and t[2] must be set to correct values already.
     */
    void Stp7Formulas::calcCoeffsDoubleDecProfile_W(double coeffs[7], double x0, double xTarget,
            double v0, double vmax, double a0, double amax, double jmax, double da, double dc, double t[8])
    {
        double t1 = jmax * jmax;
        double t2 = t1 * t1;
    ...
    void Stp7Formulas::calcTimeIntervallsDoubleDecProfile_W(double t[8], double root,
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc)
    {
        t[4] = 0;
    ...
    void Stp7Formulas::calcCoeffsStretchedProfileTT(double coeffs[7],
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
    ...
    void Stp7Formulas::calcTimeIntervallsStretchedProfileTT(double t[8], double root,
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcCoeffsStretchedProfileWW(double coeffs[7],
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcTimeIntervallsStretchedProfileWW(double t[8], double root,
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcCoeffsStretchedProfileTW(double coeffs[7],
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcTimeIntervallsStretchedProfileTW(double t[8], double root,
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcCoeffsStretchedProfileWT(double coeffs[7],
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcTimeIntervallsStretchedProfileWT(double t[8], double root,
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcCoeffsStretchedDoubleDecProfileWcW(double coeffs[7],
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcTimeIntervallsStretchedDoubleDecProfileWcW(double t[8], double root,
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcCoeffsStretchedDoubleDecProfileWW(double coeffs[7],
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcTimeIntervallsStretchedDoubleDecProfileWW(double t[8], double root,
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcCoeffsStretchedDoubleDecProfileTcW(double coeffs[7],
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcTimeIntervallsStretchedDoubleDecProfileTcW(double t[8], double root,
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcCoeffsStretchedDoubleDecProfileTW(double coeffs[7],
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcTimeIntervallsStretchedDoubleDecProfileTW(double t[8], double root,
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcCoeffsStretchedDoubleDecProfileWcT(double coeffs[7],
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcTimeIntervallsStretchedDoubleDecProfileWcT(double t[8], double root,
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcCoeffsStretchedDoubleDecProfileWT(double coeffs[7],
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcTimeIntervallsStretchedDoubleDecProfileWT(double t[8], double root,
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcCoeffsStretchedDoubleDecProfileTcT(double coeffs[7],
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcTimeIntervallsStretchedDoubleDecProfileTcT(double t[8], double root,
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcCoeffsStretchedDoubleDecProfileTT(double coeffs[7],
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
    ...
    void Stp7Formulas::calcTimeIntervallsStretchedDoubleDecProfileTT(double t[8], double root,
            double x0, double xTarget, double v0, double vmax,
            double a0, double amax, double jmax, double da, double dc,
            double stretchToTime)
    {
