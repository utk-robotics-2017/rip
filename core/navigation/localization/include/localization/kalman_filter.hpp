...
#include "gaussian_sensor_model.hpp.hpp"
    ...
    namespace navigation
    {
        namespace localization
        {
            ...
            public:
                ...
                virtual ~KalmanActionModel() override
                {
                }
            ...
            public:
                ...
                virtual ~KalmanSensorModel() override {}
            ...
            public:
                ...
                std::shared_ptr<GaussianMoment<X>> bayesianInference(
                        ...
                        const Z& data,
                        const GaussianMoment<X>& belief) const
                {
                    // Table 3.1 p42
                    auto& z = data;
                ...
                std::shared_ptr<GaussianMoment<X>> marginalize(const KalmanActionModel<U, X>& model,
                            const U& action,
                            const GaussianMoment<X>& state) const
                {
                    // Table 3.1 p42
