...
namespace rip
{
    namespace navigation
    {
        ...
        public:
             ...
             * Default Constructor
             */
            RobotFootprintModel() = default;

            /**
             * Default Destructor
             */
            virtual ~RobotFootprintModel() = default;
             ...
             */
            virtual units::Distance distance(const Pose& current_pose, std::shared_ptr<Obstacle> obstacle) const = 0;
             ...
             * @return              Euclidean distance from the robot to the obstacle
             */
            virtual units::Distance estimateSpatioTemporalDistance(const Pose& current_pose, std::shared_ptr<Obstacle> obstacle, const units::Time& t) const = 0;
