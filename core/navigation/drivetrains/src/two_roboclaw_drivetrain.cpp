...
namespace rip
{
    namespace navigation
    {
        namespace drivetrains
        {
            ...
            bool TwoRoboclawDrivetrain::hasEncoders() const
            {
                return true;
            }

            std::vector<units::Distance> TwoRoboclawDrivetrain::readEncoders(const std::vector<Motor>& motors) const
            {
            ...
            units::Distance TwoRoboclawDrivetrain::readEncoder(const Motor& motor) const
            {
                switch(motor)
                {
                case Motor::kFrontLeft:
            ...
            units::Velocity TwoRoboclawDrivetrain::readEncoderVelocity(const Motor& motor) const
            {
                switch(motor)
                {
                case Motor::kFrontLeft:
            ...
            bool TwoRoboclawDrivetrain::hasGyro() const
            {
                return m_navx != nullptr;
            }

            units::Angle TwoRoboclawDrivetrain::readYaw() const
            {
