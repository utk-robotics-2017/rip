...
namespace rip
{
    namespace motorcontrollers
    {
        namespace roboclaw
        {
             ...
             */
            class Roboclaw : public framework::Subsystem
            {
            public:
                enum class Motor
                {
                ...
                Roboclaw(const nlohmann::json& config, bool test = true);
                /**
                 * @brief Destructor
                 *
                 */
                ...
                *
                */
                void validateConfig(const nlohmann::json& testcfg);
//////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////// PWM /////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////
                 ...
                 * @exception OutOfRange Thrown if the voltage is out of range
                 */
                void setMainVoltages(const units::Voltage& min, const units::Voltage& max);
...
//////////////////////////////////////////////////////////////////////////////////////////////
                 ...
                 * @exception OutOfRange Thrown if the voltage is out of range
                 */
                void setLogicVoltages(const units::Voltage& min, const units::Voltage& max);
...
//////////////////////////////////////////////////////////////////////////////////////////////
                 ...
                 */
                int32_t readEncoderRaw(Motor motor);
                 ...
                 */
                void setEncoder(Motor motor, const units::Distance& d);
...
//////////////////////////////////////////////////////////////////////////////////////////////
                 ...
                 */
                void setMaxCurrent(Motor motor, const units::Current& current);
...
//////////////////////////////////////////////////////////////////////////////////////////////
                ...
                typename std::enable_if < I < sizeof...(Args), void>::type argsToVector(std::vector<uint8_t>& command, std::tuple<Args...> tup)
                {
                    ...
                    for (unsigned int i_v = 0; i_v < size_v; i_v++)
                    {
