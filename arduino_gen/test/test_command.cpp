        ...
        namespace test
        {
            ...
            TEST(Command_callback, id_name_code)
            {
                ...
                ASSERT_EQ(command->callback(1),
                    ...
                    "\t\tcmdMessenger.sendBinCmd(Commands::kError, Commands::No);\n"
                    "\t\treturn;\n"
                    "\t}\n"
                    "\t// Proper indentation is semi-important\n"
                    "\t// Even on the second line\n"
                    "\tcmdMessenger.sendBinCmd(Commands::kAcknowledge, Commands::No);\n"
                    "}\n");
            }
            ...
            TEST(Command_callback, id_name_index_num_true_code)
            {
                ...
                ASSERT_EQ(command->callback(1),
                    ...
                    "\tint indexNum = cmdMessenger.readBinArg<int>();\n"
                    "\tif(!cmdMessenger.isArgOk() || indexNum < 0 || indexNum > 1) {\n"
                    "\t\tcmdMessenger.sendBinCmd(Commands::kError, Commands::Easter);\n"
                    "\t\treturn;\n"
                    "\t}\n"
                    "\t// All i'm saying, is that I need an index-num\n"
                    "\tcmdMessenger.sendBinCmd(Commands::kAcknowledge, Commands::Easter);\n"
                    "}\n");
            }
            ...
            TEST(Command_callback, id_name_index_num_false_code)
            {
                ...
                ASSERT_EQ(command->callback(1),
                    "void Picky() {\n"
                    "\t// That other guy is too needy, I don't need an index-num\n"
                    "\tcmdMessenger.sendBinCmd(Commands::kAcknowledge, Commands::Not);\n"
                    "}\n");
            }
            ...
            TEST(Command_callback, id_name_index_num_one_parameter_code)
            {
                ...
                ASSERT_EQ(command->callback(1),
                    ...
                    "\tint indexNum = cmdMessenger.readBinArg<int>();\n"
                    "\tif(!cmdMessenger.isArgOk() || indexNum < 0 || indexNum > 1) {\n"
                    "\t\tcmdMessenger.sendBinCmd(Commands::kError, Commands::Jurassic);\n"
                    "\t\treturn;\n"
                    "\t}\n"
                    ...
                    "\t}\n"
                    "\t// Got your nose!\n"
                    "\tcmdMessenger.sendBinCmd(Commands::kAcknowledge, Commands::Jurassic);\n"
                    "}\n");
            }
            ...
            TEST(Command_callback, id_name_index_num_two_parameters_code)
            {
                ...
                ASSERT_EQ(command->callback(1),
                    ...
                    "\tint indexNum = cmdMessenger.readBinArg<int>();\n"
                    "\tif(!cmdMessenger.isArgOk() || indexNum < 0 || indexNum > 1) {\n"
                    "\t\tcmdMessenger.sendBinCmd(Commands::kError, Commands::ACleverId);\n"
                    "\t\treturn;\n"
                    "\t}\n"
                    ...
                    "\t}\n"
                    "\t// I should probably do something with \"a\" and \"b\"\n"
                    "\tcmdMessenger.sendBinCmd(Commands::kAcknowledge, Commands::ACleverId);\n"
                    "}\n");
            }
            ...
            TEST(Command_callback, id_name_index_num_one_return_value_code)
            {
                ...
                ASSERT_EQ(command->callback(1),
                    ...
                    "\tint indexNum = cmdMessenger.readBinArg<int>();\n"
                    "\tif(!cmdMessenger.isArgOk() || indexNum < 0 || indexNum > 1) {\n"
                    "\t\tcmdMessenger.sendBinCmd(Commands::kError, Commands::Euphoria);\n"
                    "\t\treturn;\n"
                    "\t}\n"
                    "\tint cloud;\n"
                    "\tcloud = 9;\n"
                    "\tcmdMessenger.sendBinCmd(Commands::kAcknowledge, Commands::Euphoria);\n"
                    "\tcmdMessenger.sendCmdStart(Commands::EuphoriaResult);\n"
            ...
            TEST(Command_callback, id_name_index_num_two_return_values_code)
            {
                ...
                ASSERT_EQ(command->callback(1),
                    ...
                    "\tint indexNum = cmdMessenger.readBinArg<int>();\n"
                    "\tif(!cmdMessenger.isArgOk() || indexNum < 0 || indexNum > 1) {\n"
                    "\t\tcmdMessenger.sendBinCmd(Commands::kError, Commands::ThreeDog);\n"
                    "\t\treturn;\n"
                    "\t}\n"
                    ...
                    "\tTheLoneliestNumber = 1;\n"
                    "\tNotAsBadAsOne = 2;\n"
                    "\tcmdMessenger.sendBinCmd(Commands::kAcknowledge, Commands::ThreeDog);\n"
                    "\tcmdMessenger.sendCmdStart(Commands::ThreeDogResult);\n"
            ...
            TEST(Command_callback, id_name_index_num_one_parameter_one_return_value_code)
            {
                ...
                ASSERT_EQ(command->callback(1),
                    ...
                    "\tint indexNum = cmdMessenger.readBinArg<int>();\n"
                    "\tif(!cmdMessenger.isArgOk() || indexNum < 0 || indexNum > 1) {\n"
                    "\t\tcmdMessenger.sendBinCmd(Commands::kError, Commands::kEcho);\n"
                    "\t\treturn;\n"
                    "\t}\n"
                    ...
                    "\tchar out;\n"
                    "\tout = in;\n"
                    "\tcmdMessenger.sendBinCmd(Commands::kAcknowledge, Commands::kEcho);\n"
                    "\tcmdMessenger.sendCmdStart(Commands::kEchoResult);\n"
            ...
            TEST(Command_callback, id_name_index_num_two_parameters_one_return_value_code)
            {
                ...
                ASSERT_EQ(command->callback(1),
                    ...
                    "\tint indexNum = cmdMessenger.readBinArg<int>();\n"
                    "\tif(!cmdMessenger.isArgOk() || indexNum < 0 || indexNum > 1) {\n"
                    "\t\tcmdMessenger.sendBinCmd(Commands::kError, Commands::kExponent);\n"
                    "\t\treturn;\n"
                    "\t}\n"
                    ...
                    "\tfor (int i = 0; i < n; i++)\n"
                    "\t    rv *= x;\n"
                    "\tcmdMessenger.sendBinCmd(Commands::kAcknowledge, Commands::kExponent);\n"
                    "\tcmdMessenger.sendCmdStart(Commands::kExponentResult);\n"
            ...
            TEST(Command_callback, id_name_index_num_one_parameter_two_return_values_code)
            {
                ...
                ASSERT_EQ(command->callback(1),
                    ...
                    "\tint indexNum = cmdMessenger.readBinArg<int>();\n"
                    "\tif(!cmdMessenger.isArgOk() || indexNum < 0 || indexNum > 1) {\n"
                    "\t\tcmdMessenger.sendBinCmd(Commands::kError, Commands::kOneToTwo);\n"
                    "\t\treturn;\n"
                    "\t}\n"
                    "\tint a = cmdMessenger.readBinArg<int>();\n"
                    "\tif(!cmdMessenger.isArgOk()) {\n"
                    ...
                    "\tint rv2;\n"
                    "\t// Make two outputs from one input\n"
                    "\tcmdMessenger.sendBinCmd(Commands::kAcknowledge, Commands::kOneToTwo);\n"
                    "\tcmdMessenger.sendCmdStart(Commands::kOneToTwoResult);\n"
            ...
            TEST(Command_callback, id_name_index_num_two_parameters_two_return_values_code)
            {
                ...
                ASSERT_EQ(command->callback(1),
                    ...
                    "\tint indexNum = cmdMessenger.readBinArg<int>();\n"
                    "\tif(!cmdMessenger.isArgOk() || indexNum < 0 || indexNum > 1) {\n"
                    "\t\tcmdMessenger.sendBinCmd(Commands::kError, Commands::kDivide);\n"
                    "\t\treturn;\n"
                    "\t}\n"
                    "\tint a = cmdMessenger.readBinArg<int>();\n"
                    "\tif(!cmdMessenger.isArgOk()) {\n"
                    ...
                    "\tquotient = a / b;\n"
                    "\tremainder = a % b;\n"
                    "\tcmdMessenger.sendBinCmd(Commands::kAcknowledge, Commands::kDivide);\n"
                    "\tcmdMessenger.sendCmdStart(Commands::kDivideResult);\n"
