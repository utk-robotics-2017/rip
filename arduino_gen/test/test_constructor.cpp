    ...
    namespace arduinogen
    {
        namespace test
        {
            ...
            TEST(Constructor, IntArgument)
            {
                ...
                appendage_map.emplace(std::make_pair("A Type", std::make_shared<Appendage>(j, std::vector<std::string>{}, false)));
            ...
            TEST(Constructor, SingleAppendageMultipleArgument)
            {
                ...
                appendage_map.emplace(std::make_pair("Other Type", std::make_shared<Appendage>(j, std::vector<std::string>{}, false)));
                appendage_map.emplace(std::make_pair("abc Type", std::make_shared<Appendage>(j, std::vector<std::string>{}, false)));
                appendage_map.emplace(std::make_pair("one more Type", std::make_shared<Appendage>(j, std::vector<std::string>{}, false)));
